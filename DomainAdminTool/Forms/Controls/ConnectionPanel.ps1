...
$script:comboDomain.Items.AddRange(@(	
    [PSCustomObject]@{Name = "域控（深圳）- serverAD.abc.com"; Server = "serverAD.abc.com"; SystemAccount= "abc\admin"; Password = "abc123456"},
    [PSCustomObject]@{Name = "域控（上海）- server03.abc01.com"; Server = "server03.abc01.com"; SystemAccount= "abc01\administrator"; Password = "abc123456"},
    [PSCustomObject]@{Name = "测试域控（北京）- server04.abc04.com"; Server = "server04.abc04.com"; SystemAccount= "abc04\administrator"; Password = ""}	
))
...
$script:connectionTable.Controls.Add($script:ouButtonPanel, 1, 3)  # 放置在第4行第2列
