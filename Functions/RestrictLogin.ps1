...
function ShowRestrictLoginForm {
    ...
    $mainTable.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Absolute, 80))) # 按钮列
    $mainTable.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Absolute, 10)))  # 间距
    $mainTable.ColumnStyles.Add((New-Object System.Windows.Forms.ColumnStyle([System.Windows.Forms.SizeType]::Percent, 40)))
    ...
    $btnAddAll.Text = "<<"
    $btnAddAll.Dock = "Top"
    $btnAddAll.Margin = New-Object System.Windows.Forms.Padding(0, 0, 0, 5)
    # 使用ToolTip组件设置提示文本（替代原ToolTipText属性）
    $toolTip.SetToolTip($btnAddAll, "添加所有域内计算机到允许列表")

    $btnAddSelected = New-Object System.Windows.Forms.Button
    $btnAddSelected.Text = "<"
    $btnAddSelected.Dock = "Top"
    $btnAddSelected.Margin = New-Object System.Windows.Forms.Padding(0, 0, 0, 5)
    ...
    $btnRemoveSelected.Dock = "Top"
    $btnRemoveSelected.Margin = New-Object System.Windows.Forms.Padding(0, 0, 0, 5)
    $toolTip.SetToolTip($btnRemoveSelected, "从允许列表移除选中的计算机")

    $btnRemoveAll = New-Object System.Windows.Forms.Button
    $btnRemoveAll.Text = ">>"
    $btnRemoveAll.Dock = "Top"
    $btnRemoveAll.Margin = New-Object System.Windows.Forms.Padding(0, 0, 0, 5)
    ...
    $btnPanel.Controls.Add($btnAddAll)  # 逆序添加（Dock=Top时先加的在下面）
    ...
    function LoadDomainComputers {
        try {
            # 显示加载提示
            #[System.Windows.Forms.MessageBox]::Show("正在从域控检索所有计算机，请稍候...", "加载中", [System.Windows.Forms.MessageBoxButtons]::OK, [System.Windows.Forms.MessageBoxIcon]::Information)
